...
- `frontend/src/pages/PlaylistDetail.tsx` shows two right-side `VideoDetailListCard` cards alongside the playlist items table: `Top performing content` (`sort_by=views`) and `Top performing content (last 90 days)` (`sort_by=recent_views`).
