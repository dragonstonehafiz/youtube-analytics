...
from src.routes import analytics, audience, comments, competitors, llm, playlists, stats, sync, videos
...
router.include_router(competitors.router, tags=["competitors"])
