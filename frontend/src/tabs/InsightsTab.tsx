...
export default function InsightsTab({ range, filterParam, playlistId }: Props) {
  ...
  }, [range.start, range.end, JSON.stringify(filterParam)])
  ...
  return (
    <div className="insights-tab-layout">
      ...
      <div ref={scatterContainerRef} className="insights-tab-chart-wrapper">
      ...
      <div ref={histogramContainerRef} className="insights-tab-chart-wrapper">
      ...
      <div ref={barChartContainerRef} className="insights-tab-chart-wrapper">
